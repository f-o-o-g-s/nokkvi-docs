...
Both hotkeys operate on the *currently playing* track — if nothing's playing, a toast tells you so. To run either action against a different track, album, or artist, right-click it and pick **Find Similar** or **Top Songs** from the context menu; those entries act on the focused / right-clicked item.
