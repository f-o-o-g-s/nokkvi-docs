...
![Horizontal artwork layout — square cover beside the slot list (always_native)](../../../assets/artwork-panel-horizontal.webp)

![Vertical artwork layout — square cover stacked above the slot list (always_vertical_native)](../../../assets/artwork-panel-vertical.webp)
