...
The chip is a small pin icon that sits alongside the other view-header buttons (sort / refresh / center / columns). Hover for a tooltip showing the current default's name — or *(none) — click to set* when nothing's pinned.
