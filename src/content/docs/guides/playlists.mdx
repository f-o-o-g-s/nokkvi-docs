...
Playlists are shown with cover art (a 3×3 collage if the playlist spans multiple albums), name, song count, and duration. Search matches playlist name and comment. Private playlists carry a small lock icon next to the name; public ones render without it.
