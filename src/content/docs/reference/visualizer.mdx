...
Over-cover drawing shares its surface with the [synced-lyrics overlay](/guides/lyrics/): with both on, the visualizer keeps playing beneath the words rather than yielding to them.
