...
Optional overlay for `lines` mode: a small boat rides the waveform. Toggle under **Settings → Visualizer → Lines** or set [`visualizer.lines.boat = true`](/reference/config/#general-visualizer) in `config.toml`.
