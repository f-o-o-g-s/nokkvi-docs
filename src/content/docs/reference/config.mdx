...
| Key | Default | Description |
| :--- | :--- | :--- |
| `start_view` | `"Queue"` | The view to show on startup. Options: `Queue`, `Albums`, `Artists`, `Songs`, `Genres`, `Playlists`, `Harbour`. Any unrecognized value (e.g. `Radios`, `Settings`) falls back to `Queue`. |
