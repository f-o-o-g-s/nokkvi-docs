...
| `visualizer.milkdrop.preset_source` | `"all"` | Which presets are drawn: `all` (every preset you haven't hidden) or `favorites_only` (your favorites, and all of them while you have none). |
